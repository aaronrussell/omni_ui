defmodule OmniUI.Artifacts.Tool do
  ...
  # new/0 is generated by Omni.Tool macro with a nil default, but init/1
  # requires :session_id so new/0 can never succeed.
  # Fixed upstream from omni >= v1.2.2 (defaults to [])
